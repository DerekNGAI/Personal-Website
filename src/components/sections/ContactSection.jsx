...
const ContactSection = () => (
  <>
      ...
      <div className="flex h-1/2 flex-col items-center justify-around">
        ...
        <button
          className="group relative w-1/2 cursor-pointer overflow-hidden rounded-md border
            ...
            outline-none hover:border-t-4 hover:border-b hover:brightness-150 active:opacity-75"
        >
          <span
            className="absolute -top-[150%] left-0 inline-flex h-[5px] w-80 rounded-md bg-red-400
              opacity-50 shadow-[0_0_10px_10px_rgba(0,0,0,0.3)] shadow-red-400 duration-500
              group-hover:top-[150%]"
          />
    ...
    <div className="flex h-1/4 w-full flex-col items-start justify-between">
      ...
      <p className="text-base">© 2025 Derek NGAI</p>
    </div>
  </>
);
